 ...
 */
final class Version20201101101847 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE invoice_lines ADD CONSTRAINT FK_72DBDC234EF8BE34 FOREIGN KEY (id_invoice) REFERENCES invoice (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
